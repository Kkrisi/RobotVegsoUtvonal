...
class Belso():
    ...
    def versenyBelulrol(self):
        self.robot.settings(straight_speed=1200)
        self.robot.straight(1450)
        wait(1000)
        self.robot.turn(-100)
        wait(1000)
        self.robot.straight(1150)#1180
        wait(1000)
        self.robot.turn(-100)
        wait(1000)
        self.robot.straight(1700)#1900
        wait(1000)                      #belülről indul
        self.robot.turn(-105)#-99
        wait(1000)
        self.robot.straight(1200)
        wait(1000)
        self.robot.turn(-100)#-98
        wait(1000)
        self.robot.straight(400)
        wait(1000)
